...
char* Cmodels::print_output_for_sat() {
    ...
    for (int indA = 0; indA < program.clauses.size(); indA++)
            ptr += program.clauses[indA]->printsmtcnf(ptr);
    return buff;
}
